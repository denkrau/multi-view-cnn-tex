...
\begin{figure}
	...
	\end{subfigure}
	\caption[Common activation functions]{Plots and equations of common used activation functions. Where the Bias $b$ is the threshold value and $s$ adds a small slope. Usually, the latter is very small like $s=0.01$.}
