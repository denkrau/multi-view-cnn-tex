...
\abk[Ca03 ]{$\tilde{\vec{X}} \in \mathbb{R}^{n_v \times n_x \times m/n_v}$}{Multi-View Input Matrix}
...
\abk[Ca06 ]{$\tilde{\vec{Y}} \in \mathbb{R}^{n_v \times n_y \times m/n_v}$}{Multi-View Label Matrix}
