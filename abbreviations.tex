...
\abk[Ba11 ]{$n_g$}{Number of Groups per Multi-View}
...
\abk[Ca03 ]{$\tilde{\vec{X}} \in \mathbb{R}^{m/n_v \times n_v \times Height \times Width \times Channels}$}{Multi-View Input Matrix}
...
\abk[Ca06 ]{$\tilde{\vec{Y}} \in \mathbb{R}^{n_y \times m/n_v}$}{Multi-View Label Matrix}
